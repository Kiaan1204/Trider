// The ClusterManagerRendered class helps in generating the icon present on the map by setting the image, height, and width of the icon.
//Kiaan Upamanyu
